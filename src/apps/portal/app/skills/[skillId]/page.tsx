...
import { getInfraSkillDetail } from '@/lib/api-client'
...
import type { InfraSkillDetailResponse, SkillDefinitionResponse } from '@/lib/types'
    ...
    <div className="mt-4 space-y-4">
      ...
      <header className="flex items-start justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            type="button"
            onClick={() => router.push(`/skills/${encodeURIComponent(skillId)}/edit`)}
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
          ...
          <p className="text-sm text-slate-500">版本记录、评测证据与发布记录请前往对应页签查看。</p>
        </section>
      </div>
    </div>
  )
