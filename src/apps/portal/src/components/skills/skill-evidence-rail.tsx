    ...
    <div className="divide-y divide-slate-200">
      ...
      <section className="p-4">
        ...
        <dl className="mt-3 space-y-2 text-xs">
          <div className="flex justify-between gap-3"><dt className="text-slate-500">候选版本</dt><dd>{item.candidate_version ?? latestVersion?.semantic_version ?? '—'}</dd></div>
...
export default function SkillEvidenceRail(props: SkillEvidenceRailProps) {
  ...
  return variant === 'rail' ? (
    <aside aria-label="治理证据" className="hidden min-h-0 overflow-y-auto border-l border-slate-200 bg-slate-50/60 min-[1120px]:block xl:block">
