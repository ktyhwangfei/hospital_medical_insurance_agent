...
def test_postgres_storage_reports_unhealthy_without_driver_connection():
    ...
    assert health.details["reason"] == "driver_not_configured"
    assert health.details["unchecked_dependencies"] == "redis"
...
def test_redis_cache_reports_unhealthy_without_driver_connection():
    ...
    assert health.details["reason"] == "driver_not_configured"
    assert health.details["unchecked_dependencies"] == "postgresql"
